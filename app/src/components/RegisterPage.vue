<template>
  <section class="bg-gray-50 dark:bg-gray-900 relative">
    <video autoplay muted loop class="absolute inset-0 w-full h-full object-cover object-center z-0">
      <source src="@/assets/videos/planet_-_73425%20(720p).mp4" type="video/mp4">
    </video>
    <div class="absolute inset-0 bg-black opacity-30 z-1"></div>

    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 relative z-2">
      <RouterLink :to="{ name:'home'}" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        <img class="w-12 h-12 mr-2" src="@/assets/images/logo.png" alt="logo">
        Idle Space Tycoon
      </RouterLink>
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" @submit.prevent="register">
            ...
            <div>
              ...
              <input type="password" name="confirm-password" v-model="form.confirmPassword" placeholder="••••••••"
                     class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                     required>
            </div>
            <button type="submit"
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              ...
              <RouterLink :to="{ name:'login'}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">
                Log in here
              </RouterLink>
            </p>
          </form>
...
<script setup lang="ts">
  ...
  import type {UserRegister} from "@/types/user.interfaces";
